...
def buat_tabel_otomatis():
    ...
    """
    try:
        # Supabase pakai endpoint rpc/sql
        r = requests.post(
        ...
        if r.status_code in [200, 201]:
            send_telegram("✅ Tabel 'orders' auto dibuat / sudah ada")
        else:
            send_telegram(f"⚠️ Gagal auto buat tabel: {r.text}")
    except Exception as e:
        send_telegram(f"❌ Error buat tabel: {e}")
...
async def main():
    ...
    buat_tabel_otomatis() # PANGGIL PERTAMA KALI
