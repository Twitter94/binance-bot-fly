        ...
        if harga_beli_asli > 0: # MODE 2A: KETEMU RIWAYAT BELI
            ...
            if len(insert_res) > 0:
                ...
                if price > harga_beli_asli: # WAJIB PROFIT
                    ...
                    send_telegram(f"🛑 MODE 2A DITAHAN: Harga {price:.2f} < Beli {harga_beli_asli:.2f}")
